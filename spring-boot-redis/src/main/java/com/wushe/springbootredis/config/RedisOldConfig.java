//package com.wushe.springbootredis.config;
//
...
// * @Company: 成都旺小宝科技有限公司
// * @Author: jtb
// * @CreateDate: 2020/12/14 11:50
// * @UpdateDate: 2020/12/14 11:50
// * @UpdateRemark: init
// * @Version: 1.0
// * @menu
// */
...
//     * 注入封装RedisTemplate
//     */
//    @Bean(name = "redisUtilOld")
//    public RedisUtilOld redisUtil(RedisTemplate<String, Object> redisTemplate) {
//        RedisUtilOld redisUtil = new RedisUtilOld();
